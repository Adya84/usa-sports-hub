...
/* NBA league pages: basketball-specific presentation wired to all NBA sensors. */
UsaSportsHubPanel.prototype.nbaPageStyles=function(){
  return '<style>'+
  '.nba-site{display:grid;gap:16px}.nba-hero{position:relative;overflow:hidden;border:1px solid #9a5d22;border-radius:14px;padding:26px;background:linear-gradient(115deg,#201306f5,#100b06f0);box-shadow:0 14px 34px #0008}.nba-hero:after{content:"NBA";position:absolute;right:22px;top:-28px;font-size:9rem;font-weight:1000;color:#ffffff08;letter-spacing:-.08em}.nba-hero small{color:#ffc46b;font-size:.88rem;font-weight:950;letter-spacing:.12em}.nba-hero h2{margin:7px 0 4px;font-size:clamp(2rem,4vw,3.4rem)}.nba-hero p{margin:0;color:#d6c1aa;font-size:1.05rem;line-height:1.5}.nba-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:11px}.nba-kpi{border:1px solid #7b4c22;background:linear-gradient(145deg,#211505,#100b05);border-radius:11px;padding:17px 16px}.nba-kpi small{display:block;color:#ffc56a;font-size:.8rem;font-weight:950;letter-spacing:.07em}.nba-kpi b{display:block;font-size:1.75rem;line-height:1.1;margin-top:5px}.nba-kpi span{color:#c7ad93;font-size:.9rem}.nba-card{border:1px solid #60401f;background:#100b06ef;border-radius:12px;overflow:hidden;box-shadow:0 10px 28px #0006}.nba-card>header{display:flex;align-items:center;justify-content:space-between;padding:14px 17px;background:linear-gradient(90deg,#4b2d0b,#171008);border-bottom:1px solid #986024}.nba-card>header b{font-size:.95rem;letter-spacing:.07em}.nba-card>header span{font-size:.88rem;color:#ffc56a;font-weight:800}.nba-grid{display:grid;grid-template-columns:1.45fr .9fr;gap:14px}.nba-game-list{display:grid}.nba-game-row{display:grid;grid-template-columns:115px minmax(360px,620px) 170px 36px;gap:20px;justify-content:start;align-items:center;width:100%;border:0;border-bottom:1px solid #332313;background:transparent;color:#fff;padding:17px 18px;text-align:left;cursor:pointer}.nba-game-row:hover{background:#2a1b0b}.nba-game-row:last-child{border-bottom:0}.nba-game-time b{display:block;font-size:1rem}.nba-game-time small{display:block;color:#b9a086;font-size:.84rem;margin-top:2px}.nba-match-mini{display:grid;gap:8px;min-width:0}.nba-match-mini div{display:grid;grid-template-columns:34px minmax(0,1fr) 48px;gap:11px;align-items:center}.nba-match-mini img,.nba-match-mini .live-team-logo{width:31px;height:31px}.nba-match-mini b{font-size:1.02rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.nba-match-mini strong{font-size:1.2rem;text-align:right}.nba-game-state{font-size:.9rem;font-weight:950;color:#ffc46b;line-height:1.25}.nba-game-open{font-size:1.55rem;color:#ffb54a;text-align:center}.nba-standing-head,.nba-standing-row{display:grid;grid-template-columns:38px minmax(210px,1.4fr) 80px 70px 80px 85px;gap:10px;align-items:center;padding:12px 14px;min-width:670px}.nba-standing-head{background:#20170f;color:#c1ad98;font-size:.72rem;font-weight:950;letter-spacing:.06em}.nba-standing-row{border-bottom:1px solid #312316;font-size:.92rem;cursor:pointer}.nba-standing-row:hover{background:#2a1c0e}.nba-standing-row .team{display:flex;align-items:center;gap:10px;font-weight:850}.nba-standing-row .team img,.nba-standing-row .team .live-team-logo{width:31px;height:31px}.nba-group-title{padding:11px 14px;background:#3a230b;color:#ffc15b;font-weight:950;font-size:.82rem;letter-spacing:.08em}.nba-team-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:11px}.nba-team-tile{display:flex;align-items:center;gap:12px;border:1px solid #60401f;background:linear-gradient(135deg,#211606,#100b05);border-radius:11px;padding:15px;color:#fff;cursor:pointer;text-align:left}.nba-team-tile:hover{transform:translateY(-1px);border-color:#ffc15b}.nba-team-tile img,.nba-team-tile .live-team-logo{width:54px;height:54px}.nba-team-tile h3{margin:0;font-size:1rem}.nba-team-tile small{display:block;color:#c3ad98;margin-top:3px}.nba-player-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:11px}.nba-player-card{border:1px solid #60401f;border-radius:12px;background:linear-gradient(160deg,#241807,#0d0905);padding:14px;text-align:center}.nba-player-card .mlb-player-photo,.nba-player-card .mlb-avatar{width:88px;height:88px;margin:auto;border-radius:50%}.nba-player-card h3{margin:10px 0 3px;font-size:1rem}.nba-player-card>small{display:block;color:#c2aa92}.nba-player-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:5px;margin-top:11px}.nba-player-stats span{background:#0b0703;border:1px solid #ffffff12;padding:7px}.nba-player-stats b,.nba-player-stats small{display:block}.nba-player-stats small{font-size:.62rem;color:#a58b72}.nba-stat-table{display:grid}.nba-stat-row{display:grid;grid-template-columns:minmax(230px,.95fr) minmax(260px,1.05fr);gap:24px;padding:15px 18px;border-bottom:1px solid #332315;align-items:center}.nba-stat-row b{font-size:1.02rem}.nba-stat-meta{display:flex;align-items:center;gap:18px;min-width:0}.nba-stat-meta span{color:#d0b89f;font-size:.95rem}.nba-stat-meta strong{margin-left:auto;color:#ffc15b;font-size:1rem}.nba-leaders{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;padding:12px}.nba-leader{display:flex;align-items:center;gap:11px;border:1px solid #5c3b1d;background:#181006;border-radius:10px;padding:12px}.nba-leader .mlb-player-photo,.nba-leader .mlb-avatar{width:52px;height:52px}.nba-leader div{min-width:0}.nba-leader small,.nba-leader b,.nba-leader strong{display:block}.nba-leader small{color:#bda78f}.nba-leader strong{color:#ffc15b;font-size:1.2rem}.nba-news-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.nba-news{border:1px solid #60401f;border-radius:12px;background:linear-gradient(145deg,#211606,#0e0905);padding:17px;color:#fff;text-align:left;cursor:pointer}.nba-news small{color:#ffc15b;font-weight:950}.nba-news h3{margin:8px 0;font-size:1.1rem}.nba-news p{margin:0;color:#c8b29c;line-height:1.45}.nba-news footer{margin-top:13px;color:#a58e78;font-size:.8rem}.nba-team-focus{display:grid;grid-template-columns:110px 1fr auto;gap:18px;align-items:center;border:1px solid #865522;border-radius:13px;padding:18px;background:linear-gradient(120deg,#2b1a08,#100b05)}.nba-team-focus img{width:96px;height:96px;object-fit:contain}.nba-team-focus h2{margin:0}.nba-team-focus p{margin:5px 0 0;color:#c7b098}.nba-focus-record{text-align:right}.nba-focus-record b{display:block;font-size:2rem}.nba-focus-record small{color:#ffc46b}.nba-injury-row{display:grid;grid-template-columns:minmax(160px,1fr) 150px;gap:10px;padding:11px 14px;border-bottom:1px solid #332316}.nba-injury-row span{color:#ff9ba6;text-align:right}.nba-live-empty{padding:28px;text-align:center;color:#c1aa93}.nba-live-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.nba-live-card{border:1px solid #865522;background:linear-gradient(145deg,#251807,#0f0a05);border-radius:12px;padding:15px;color:#fff;text-align:left;cursor:pointer}.nba-live-card.active{box-shadow:0 0 0 1px #ffc15b inset,0 0 22px #ff9f1c33}.nba-live-card header{display:flex;justify-content:space-between;gap:12px;color:#ffc46b;font-weight:900}.nba-live-card .teamline{display:grid;grid-template-columns:42px 1fr auto;gap:10px;align-items:center;padding:11px 0;border-bottom:1px solid #ffffff12}.nba-live-card .teamline:last-of-type{border-bottom:0}.nba-live-card .teamline img,.nba-live-card .teamline .live-team-logo{width:38px;height:38px}.nba-live-card .teamline b{font-size:1.08rem}.nba-live-card .teamline strong{font-size:1.6rem}.nba-live-card footer{display:flex;justify-content:space-between;gap:12px;margin-top:10px;color:#c1aa93}.nba-live-card footer b{color:#ffc15b}.nba-empty{padding:28px;text-align:center;color:#c2ac96}@media(max-width:1100px){.nba-grid{grid-template-columns:1fr}.nba-team-grid,.nba-player-grid{grid-template-columns:repeat(2,1fr)}.nba-leaders{grid-template-columns:repeat(2,1fr)}}@media(max-width:760px){.nba-kpis{grid-template-columns:repeat(2,1fr)}.nba-team-grid,.nba-player-grid,.nba-news-grid,.nba-live-grid,.nba-leaders{grid-template-columns:1fr}.nba-game-row{grid-template-columns:82px minmax(0,1fr) 34px;gap:10px;padding:14px 12px}.nba-game-state{grid-column:2;font-size:.82rem}.nba-game-open{grid-column:3;grid-row:1/3}.nba-match-mini div{grid-template-columns:30px minmax(0,1fr) 38px}.nba-stat-row{grid-template-columns:1fr;gap:5px;padding:13px 12px}.nba-stat-meta{justify-content:space-between}.nba-team-focus{grid-template-columns:70px 1fr}.nba-team-focus img{width:64px;height:64px}.nba-focus-record{grid-column:1/-1;text-align:left}}'+
  '</style>';
};

UsaSportsHubPanel.prototype.nbaGameRow=function(game){
  const start=game?.start_time?new Date(game.start_time):null;
  const valid=start&&!Number.isNaN(start.getTime());
  const day=valid?new Intl.DateTimeFormat(undefined,{month:'short',day:'numeric'}).format(start):'Game';
  const time=valid?new Intl.DateTimeFormat(undefined,{hour:'2-digit',minute:'2-digit'}).format(start):'';
  const state=game?.is_live?([game.period_label,game.clock].filter(Boolean).join(' · ')||game.status_detail||'LIVE'):(game?.is_final?'FINAL':(game?.status_detail||'SCHEDULED'));
  return '<button class="nba-game-row" data-live-game="'+esc(game?.game_id||'')+'"><div class="nba-game-time"><b>'+esc(day)+'</b><small>'+esc(time)+'</small></div><div class="nba-match-mini"><div>'+this.gameLogo(game?.away_logo,game?.away_team)+'<b>'+esc(game?.away_team||'Away')+'</b><strong>'+esc(game?.away_score??'–')+'</strong></div><div>'+this.gameLogo(game?.home_logo,game?.home_team)+'<b>'+esc(game?.home_team||'Home')+'</b><strong>'+esc(game?.home_score??'–')+'</strong></div></div><div class="nba-game-state">'+esc(state)+'</div><div class="nba-game-open">›</div></button>';
};

UsaSportsHubPanel.prototype.nbaStandingRows=function(rows){
  const groups={};
  for(const row of rows||[]){const key=row.conference||row.division||'NBA';(groups[key]=groups[key]||[]).push(row);}
  return Object.entries(groups).map(([group,items])=>'<div class="nba-group-title">'+esc(group)+'</div>'+items.map((x,i)=>'<div class="nba-standing-row" data-nba-team-id="'+esc(x.team_id||'')+'" data-nba-team-name="'+esc(x.team||'')+'"><strong>'+esc(x.conference_rank||x.rank||x.playoff_seed||i+1)+'</strong><div class="team">'+this.gameLogo(x.logo,x.team)+'<span>'+esc(x.team||'Team')+'</span></div><span>'+esc(x.record||'–')+'</span><span>'+esc(x.winning_percentage??'–')+'</span><span>'+esc(x.streak||'–')+'</span><span>'+esc(x.playoff_seed??x.formatted_rank??'–')+'</span></div>').join('')).join('');
};

UsaSportsHubPanel.prototype.nbaLiveCard=function(game){
  const selected=String(this.selectedLiveGame||'')===String(game?.game_id||'');
  const state=game?.is_live?([game.period_label,game.clock].filter(Boolean).join(' · ')||'LIVE'):(game?.is_final?'FINAL':(game?.status_detail||'SCHEDULED'));
  return '<button class="nba-live-card '+(selected?'active':'')+'" data-live-game="'+esc(game?.game_id||'')+'"><header><span>'+esc(state)+'</span><b>'+esc(game?.broadcasts?.join?.(', ')||'')+'</b></header><div class="teamline">'+this.gameLogo(game?.away_logo,game?.away_team)+'<b>'+esc(game?.away_team||'Away')+'</b><strong>'+esc(game?.away_score??'–')+'</strong></div><div class="teamline">'+this.gameLogo(game?.home_logo,game?.home_team)+'<b>'+esc(game?.home_team||'Home')+'</b><strong>'+esc(game?.home_score??'–')+'</strong></div><footer><span>'+esc(game?.venue||game?.location||'')+'</span><b>'+(selected?'NOW PLAYING':'OPEN GAME ›')+'</b></footer></button>';
};

UsaSportsHubPanel.prototype.nbaOverviewPage=function(s,items,sensor){
  const live=items('live')||[],fixtures=items('fixtures')||[],results=items('results')||[],standings=items('standings')||[],leaders=items('leaders')||[],injuries=items('injuries')||[];
  const top=standings.find(x=>Number(x.conference_rank)===1)||standings[0]||{};
  const latest=results[results.length-1];
  return this.nbaPageStyles()+'<section class="nba-site"><div class="nba-hero"><small>NATIONAL BASKETBALL ASSOCIATION</small><h2>NBA Central</h2><p>Scores, schedules, standings, rosters, leaders, injuries and full basketball game detail from every connected NBA sensor.</p></div><div class="nba-kpis"><div class="nba-kpi"><small>LIVE NOW</small><b>'+live.length+'</b><span>active games</span></div><div class="nba-kpi"><small>UPCOMING</small><b>'+fixtures.length+'</b><span>games loaded</span></div><div class="nba-kpi"><small>TEAMS</small><b>'+standings.length+'</b><span>standings rows</span></div><div class="nba-kpi"><small>DETAIL</small><b>'+(leaders.length+injuries.length)+'</b><span>leaders & injuries</span></div></div>'+(live.length?'<section class="nba-card"><header><b>● LIVE NBA</b><span>'+live.length+' game'+(live.length===1?'':'s')+'</span></header><div class="nba-live-grid" style="padding:12px">'+live.slice(0,6).map(g=>this.nbaLiveCard(g)).join('')+'</div></section>':'')+'<div class="nba-grid"><section class="nba-card"><header><b>UP NEXT</b><span>Schedule</span></header><div class="nba-game-list">'+(fixtures.slice(0,5).map(g=>this.nbaGameRow(g)).join('')||'<div class="nba-empty">No upcoming games loaded.</div>')+'</div></section><section class="nba-card"><header><b>LEAGUE SNAPSHOT</b><span>NBA</span></header><div style="padding:18px">'+(top.team?'<div style="display:flex;align-items:center;gap:12px">'+this.gameLogo(top.logo,top.team)+'<div><small style="color:#ffc15b">TOP RANKED</small><h3 style="margin:3px 0">'+esc(top.team)+'</h3><span style="color:#c7b098">'+esc([top.record,top.conference,top.division].filter(Boolean).join(' · '))+'</span></div></div>':'<div class="nba-empty">Standings loading.</div>')+(latest?'<div style="margin-top:18px;padding-top:14px;border-top:1px solid #4a311a"><small style="color:#ffc15b">LATEST FINAL</small><b style="display:block;margin-top:5px">'+esc((latest.away_team||'')+' '+(latest.away_score??'–')+' · '+(latest.home_score??'–')+' '+(latest.home_team||''))+'</b></div>':'')+'</div></section></div></section>';
};

UsaSportsHubPanel.prototype.nbaLivePage=function(s,items,sensor){
  const live=items('live')||[],fixtures=items('fixtures')||[],ticker=items('ticker')||[];
  const scoring=items('scoring')||[],periods=items('periods')||[],leaders=items('leaders')||[];
  return this.nbaPageStyles()+'<section class="nba-site"><div class="nba-hero"><small>NBA LIVE CENTRE</small><h2>Live Basketball</h2><p>Live scores, quarter, clock, scoring, leaders and play-by-play are wired into the full Game Centre.</p></div><div class="nba-kpis"><div class="nba-kpi"><small>LIVE</small><b>'+live.length+'</b><span>games now</span></div><div class="nba-kpi"><small>UPCOMING</small><b>'+fixtures.length+'</b><span>scheduled</span></div><div class="nba-kpi"><small>TICKER</small><b>'+ticker.length+'</b><span>live feed records</span></div><div class="nba-kpi"><small>GAME DETAIL</small><b>'+(scoring.length+periods.length+leaders.length)+'</b><span>scoring · periods · leaders</span></div></div>'+(live.length?'<div class="nba-live-grid">'+live.map(g=>this.nbaLiveCard(g)).join('')+'</div>':'<section class="nba-card"><div class="nba-live-empty"><b>No NBA game is currently marked live.</b><br>The live sensor and ticker are connected; active games will move here automatically.</div></section>')+(!live.length&&fixtures.length?'<section class="nba-card"><header><b>NEXT TIPOFFS</b><span>Upcoming</span></header><div class="nba-game-list">'+fixtures.slice(0,5).map(g=>this.nbaGameRow(g)).join('')+'</div></section>':'')+'</section>';
};

UsaSportsHubPanel.prototype.nbaDataPage=function(s,tab,items,sensor,entity,score){
  const fixtures=items('fixtures')||[],results=items('results')||[],live=items('live')||[],standings=items('standings')||[],news=items('news')||[];
  const teams=entity?.attributes?.teams||[],profile=sensor('team_profile')?.attributes?.team_profile||{},squad=sensor('team_squad')?.attributes?.team_squad||[],teamStats=sensor('team_statistics')?.attributes?.team_statistics||[],teamLeaders=sensor('team_leaders')?.attributes?.team_leaders||[],teamInjuries=sensor('team_injuries')?.attributes?.team_injuries||[],favourites=sensor('status')?.attributes?.team_favourites||[];
  const gamePlayers=items('players')||[],gameStats=items('statistics')||[],gameLeaders=items('leaders')||[],gameInjuries=items('injuries')||[],lineups=items('lineups')||[],scoring=items('scoring')||[],periods=items('periods')||[],officials=items('officials')||[],situations=items('situations')||[],ticker=items('ticker')||[],related=items('related')||[];
  const box=sensor('box_score')?.attributes?.box_score||{},odds=sensor('odds')?.attributes?.odds||{},stadium=sensor('stadium')?.attributes?.stadium||{};
  const shell=(title,sub,body)=>this.nbaPageStyles()+'<section class="nba-site"><div class="nba-hero"><small>USA SPORTS HUB · NBA</small><h2>'+title+'</h2><p>'+sub+'</p></div>'+body+'</section>';
  if(tab==='Fixtures'||tab==='Results'){const games=tab==='Fixtures'?fixtures:results;return shell(tab==='Fixtures'?'NBA Schedule':'NBA Results',tab==='Fixtures'?'Upcoming NBA games with local tipoff times. Open any matchup for the full Game Centre.':'Final scores and completed matchups with full game detail.','<div class="nba-kpis"><div class="nba-kpi"><small>'+tab.toUpperCase()+'</small><b>'+games.length+'</b><span>games loaded</span></div><div class="nba-kpi"><small>TEAMS</small><b>'+teams.length+'</b><span>NBA clubs</span></div><div class="nba-kpi"><small>LIVE</small><b>'+live.length+'</b><span>right now</span></div><div class="nba-kpi"><small>STORIES</small><b>'+news.length+'</b><span>previews & recaps</span></div></div><section class="nba-card"><header><b>'+tab.toUpperCase()+'</b><span>Open a game ›</span></header><div class="nba-game-list">'+(games.map(g=>this.nbaGameRow(g)).join('')||'<div class="nba-empty">No '+tab.toLowerCase()+' available.</div>')+'</div></section>');}
  if(tab==='Standings')return shell('NBA Standings','Conference standings with record, winning percentage, streak and playoff seed.','<div class="nba-kpis"><div class="nba-kpi"><small>CLUBS</small><b>'+standings.length+'</b><span>standings rows</span></div><div class="nba-kpi"><small>CONFERENCES</small><b>'+new Set(standings.map(x=>x.conference).filter(Boolean)).size+'</b><span>loaded</span></div><div class="nba-kpi"><small>PLAYOFF SEEDS</small><b>'+standings.filter(x=>x.playoff_seed).length+'</b><span>available</span></div><div class="nba-kpi"><small>LIVE</small><b>'+live.length+'</b><span>games now</span></div></div><section class="nba-card"><header><b>NBA STANDINGS</b><span>REC · PCT · STRK · SEED</span></header><div style="overflow:auto"><div class="nba-standing-head"><span>#</span><span>TEAM</span><span>REC</span><span>PCT</span><span>STRK</span><span>SEED</span></div>'+this.nbaStandingRows(standings)+'</div></section>');
  if(tab==='Teams'){const tiles=teams.map(x=>'<button class="nba-team-tile" data-nba-team-id="'+esc(x.id||'')+'" data-nba-team-name="'+esc(x.name||'')+'">'+this.gameLogo(x.logo,x.name)+'<div><h3>'+esc(x.name||'Team')+'</h3><small>'+esc([x.abbreviation,x.conference,x.division].filter(Boolean).join(' · '))+'</small></div></button>').join('');return shell('NBA Teams','Browse all NBA clubs. Open a team to load roster, season leaders, statistics, injuries and schedule.','<div class="nba-kpis"><div class="nba-kpi"><small>NBA CLUBS</small><b>'+teams.length+'</b><span>available</span></div><div class="nba-kpi"><small>EAST</small><b>'+teams.filter(x=>String(x.conference||'').toUpperCase().includes('EAST')).length+'</b><span>clubs</span></div><div class="nba-kpi"><small>WEST</small><b>'+teams.filter(x=>String(x.conference||'').toUpperCase().includes('WEST')).length+'</b><span>clubs</span></div><div class="nba-kpi"><small>SELECTED</small><b>'+esc(profile.abbreviation||'—')+'</b><span>'+esc(profile.name||'choose a club')+'</span></div></div><div class="nba-team-grid">'+(tiles||'<div class="nba-empty">Team data is loading.</div>')+'</div>');}
  if(tab==='Players'){const source=squad.length?squad:(gamePlayers.length?gamePlayers:lineups);const cards=source.slice(0,90).map(p=>{const ss=p.season_stats&&typeof p.season_stats==='object'?p.season_stats:{};const vals=Object.entries(ss).filter(([,v])=>v!==null&&v!==undefined&&typeof v!=='object').slice(0,3);return '<article class="nba-player-card">'+this.mlbPlayerPhoto(p,'small')+'<h3>'+esc(p.name||p.full_name||'Player')+'</h3><small>'+esc([p.position_abbreviation||p.position,p.number?'#'+p.number:''].filter(Boolean).join(' · '))+'</small>'+(vals.length?'<div class="nba-player-stats">'+vals.map(([k,v])=>'<span><b>'+esc(v)+'</b><small>'+esc(this.prettyKey(k))+'</small></span>').join('')+'</div>':'')+'</article>';}).join('');return shell('NBA Players',profile.name?'Current '+profile.name+' roster with available season numbers.':'Choose a team for its full roster; otherwise selected-game players and lineups are shown.','<div class="nba-kpis"><div class="nba-kpi"><small>ROSTER</small><b>'+source.length+'</b><span>players shown</span></div><div class="nba-kpi"><small>LINEUPS</small><b>'+lineups.length+'</b><span>game records</span></div><div class="nba-kpi"><small>LEADERS</small><b>'+teamLeaders.length+'</b><span>season leaders</span></div><div class="nba-kpi"><small>INJURIES</small><b>'+teamInjuries.length+'</b><span>reported</span></div></div><div class="nba-player-grid">'+(cards||'<div class="nba-empty">Choose an NBA team or open a game to load players.</div>')+'</div>');}
  if(tab==='Stats'){const leaders=(teamLeaders.length?teamLeaders:gameLeaders).slice(0,12).map(row=>'<article class="nba-leader">'+this.mlbPlayerPhoto(row,'small')+'<div><small>'+esc(row.label||row.group||'LEADER')+'</small><b>'+esc(row.player_name||row.name||row.full_name||'Player')+'</b><strong>'+esc(row.value||row.display_value||this.itemValue(row)||'—')+'</strong></div></article>').join('');const source=teamStats.length?teamStats:gameStats;const rows=source.slice(0,100).map(row=>{const label=row.label||row.group||row.position_abbreviation||'NBA';const raw=row.value!==undefined&&row.value!==''?row.value:this.itemValue(row);const value=raw!==undefined&&raw!==null&&raw!==''&&String(raw)!=='—'&&String(raw)!==String(label)?raw:'';return '<div class="nba-stat-row"><b>'+esc(row.player_name||row.full_name||row.name||'Statistic')+'</b><div class="nba-stat-meta"><span>'+esc(label)+'</span>'+(value!==''?'<strong>'+esc(value)+'</strong>':'')+'</div></div>';}).join('');return shell('NBA Statistics','Scoring, rebounds, assists, shooting and every available basketball detail sensor in one stats centre.','<div class="nba-kpis"><div class="nba-kpi"><small>STAT ROWS</small><b>'+source.length+'</b><span>available</span></div><div class="nba-kpi"><small>SCORING</small><b>'+scoring.length+'</b><span>events</span></div><div class="nba-kpi"><small>PERIODS</small><b>'+periods.length+'</b><span>quarters</span></div><div class="nba-kpi"><small>DETAIL</small><b>'+(officials.length+situations.length+ticker.length+related.length)+'</b><span>officials · situations · ticker · related</span></div></div>'+(leaders?'<section class="nba-card"><header><b>LEADERS</b><span>'+esc(profile.name||'Current game')+'</span></header><div class="nba-leaders">'+leaders+'</div></section>':'')+'<section class="nba-card"><header><b>STATISTICS</b><span>'+esc(profile.name||'Current game')+'</span></header><div class="nba-stat-table">'+(rows||'<div class="nba-empty">Choose a team or open a game to load statistics.</div>')+'</div></section><div class="nba-grid"><section class="nba-card"><header><b>BOX SCORE</b><span>'+Object.keys(box).length+' fields</span></header><div style="padding:14px">'+(this.infoGrid(box,30)||'<div class="nba-empty">Open a game to load box score detail.</div>')+'</div></section><section class="nba-card"><header><b>GAME INFO</b><span>Odds · Venue</span></header><div style="padding:14px">'+(this.infoGrid(Object.assign({},odds,stadium),24)||'<div class="nba-empty">Open a game to load venue and odds.</div>')+'</div></section></div>');}
  if(tab==='News'){const cards=news.map(row=>'<button class="nba-news" '+(row.game_id?'data-live-game="'+esc(row.game_id)+'"':'')+'><small>'+esc(String(row.kind||'UPDATE').toUpperCase())+'</small><h3>'+esc(row.title||'NBA update')+'</h3><p>'+esc(row.summary||'Game preview or recap information.')+'</p><footer>'+esc(row.published||'')+(row.game_id?' · OPEN GAME ›':'')+'</footer></button>').join('');return shell('NBA News & Game Stories','Game previews and recaps linked directly to the relevant Game Centre.','<div class="nba-kpis"><div class="nba-kpi"><small>STORIES</small><b>'+news.length+'</b><span>loaded</span></div><div class="nba-kpi"><small>PREVIEWS</small><b>'+news.filter(x=>x.kind==='preview').length+'</b><span>upcoming</span></div><div class="nba-kpi"><small>RECAPS</small><b>'+news.filter(x=>x.kind==='recap').length+'</b><span>completed</span></div><div class="nba-kpi"><small>LIVE</small><b>'+live.length+'</b><span>games now</span></div></div><div class="nba-news-grid">'+(cards||'<div class="nba-empty">No NBA stories are available in the current feed.</div>')+'</div>');}
  if(tab==='My Team'){const teamId=String(profile.team_id||'');const games=[...live,...fixtures,...results].filter((g,i,a)=>a.findIndex(x=>String(x.game_id)===String(g.game_id))===i).filter(g=>String(g.home_team_id||'')===teamId||String(g.away_team_id||'')===teamId||g.home_team===profile.name||g.away_team===profile.name);const standing=profile.standing||standings.find(x=>String(x.team_id||'')===teamId)||{};const isFavourite=favourites.some(item=>item.sport==='nba'&&String(item.team_id)===teamId);const fav='<div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap"><b style="font-size:.82rem;letter-spacing:.07em">MY FAVOURITES '+favourites.length+'/3</b>'+favourites.map(item=>'<button class="my-favourite" data-open-favourite="'+esc(item.sport)+'|'+esc(item.team_id)+'">'+esc(item.team)+'</button>').join('')+(!isFavourite&&favourites.length<3&&teamId?'<button class="my-action" data-add-favourite="'+esc(teamId)+'">★ SAVE '+esc(profile.name||'TEAM')+'</button>':'')+(isFavourite?'<button class="my-action" data-remove-favourite="'+esc(teamId)+'">REMOVE FAVOURITE</button>':'')+'</div>';if(!teamId)return shell('My NBA Team','Select a team from the top selector or Teams/Standings to build your NBA club dashboard.','<div class="nba-empty">Choose an NBA team to load its complete team hub.</div>');const roster=squad.slice(0,24).map(p=>'<article class="nba-leader">'+this.mlbPlayerPhoto(p,'small')+'<div><b>'+esc(p.name||'Player')+'</b><small>'+esc([p.position_abbreviation||p.position,p.number?'#'+p.number:''].filter(Boolean).join(' · '))+'</small></div></article>').join('');const leaders=teamLeaders.slice(0,9).map(row=>'<article class="nba-leader">'+this.mlbPlayerPhoto(row,'small')+'<div><small>'+esc(row.label||'LEADER')+'</small><b>'+esc(row.player_name||row.name||'Player')+'</b><strong>'+esc(row.value||this.itemValue(row)||'—')+'</strong></div></article>').join('');const injuries=teamInjuries.slice(0,24).map(row=>'<div class="nba-injury-row"><b>'+esc(row.player_name||row.name||'Player')+'</b><span>'+esc(row.status||row.injury||row.injury_status||'Injury report')+'</span></div>').join('');const statRows=teamStats.slice(0,20).map(row=>'<div class="nba-stat-row"><b>'+esc(row.name||row.label||row.player_name||'Statistic')+'</b><div class="nba-stat-meta"><span>'+esc(row.group||row.category||'Team')+'</span><strong>'+esc(row.value||row.display_value||this.itemValue(row)||'—')+'</strong></div></div>').join('');return shell(esc(profile.name||'My NBA Team'),'Your NBA team hub with record, schedule, roster, leaders, team statistics and injury report.',fav+'<div class="nba-team-focus">'+(profile.logo?'<img src="'+esc(profile.logo)+'" alt="">':'')+'<div><small style="color:#ffc15b">MY NBA TEAM</small><h2>'+esc(profile.name||'Team')+'</h2><p>'+esc([profile.conference,profile.division,profile.location].filter(Boolean).join(' · '))+'</p></div><div class="nba-focus-record"><b>'+esc(standing.record||standing.short_record||'—')+'</b><small>'+esc(standing.formatted_rank||standing.conference||'Season record')+'</small></div></div><div class="nba-grid"><section class="nba-card"><header><b>SCHEDULE & RESULTS</b><span>'+games.length+' games loaded</span></header><div class="nba-game-list">'+(games.slice(0,10).map(g=>this.nbaGameRow(g)).join('')||'<div class="nba-empty">No team games loaded.</div>')+'</div></section><section class="nba-card"><header><b>SEASON SNAPSHOT</b><span>'+esc(profile.abbreviation||'')+'</span></header><div class="nba-stat-table">'+[['Record',standing.record||standing.short_record],['Conference Rank',standing.conference_rank],['Streak',standing.streak],['Last 10',standing.last_ten_games_record||standing.last_ten],['Home',standing.home_record||standing.short_home_record],['Away',standing.away_record||standing.short_away_record],['Playoff Seed',standing.playoff_seed]].filter(([,v])=>v!==null&&v!==undefined&&v!=='').map(([k,v])=>'<div class="nba-stat-row"><b>'+esc(k)+'</b><div class="nba-stat-meta"><span></span><strong>'+esc(v)+'</strong></div></div>').join('')+'</div></section></div>'+(leaders?'<section class="nba-card"><header><b>TEAM LEADERS</b><span>Season</span></header><div class="nba-leaders">'+leaders+'</div></section>':'')+'<section class="nba-card"><header><b>ROSTER</b><span>'+squad.length+' players</span></header><div class="nba-leaders">'+(roster||'<div class="nba-empty">Roster loading.</div>')+'</div></section>'+(statRows?'<section class="nba-card"><header><b>TEAM STATISTICS</b><span>Season</span></header><div class="nba-stat-table">'+statRows+'</div></section>':'')+'<section class="nba-card"><header><b>INJURY REPORT</b><span>'+teamInjuries.length+' listed</span></header>'+(injuries||'<div class="nba-empty">No published injuries.</div>')+'</section>');}
  return '';
};
...
UsaSportsHubPanel.prototype.livePage=function(s,items,sensor){
  ...
  if(this.sport==='nba')return this.nbaLivePage(s,items,sensor);
...
UsaSportsHubPanel.prototype.dataPage=function(s,tab,items,sensor,entity,score){
  ...
  if(this.sport==='nba')return this.nbaDataPage(s,tab,items,sensor,entity,score);
...
UsaSportsHubPanel.prototype.render=function(){
  ...
  if(this.sport==='nba'&&this.tab==='Overview'&&!this.selectedLiveGame){
    const content=this.shadowRoot.querySelector('.content');
    const notice=content?.querySelector('.notice');
    if(content){
      const sensor=section=>this._hass?.states?.[`sensor.usa_sports_hub_nba_${section}`];
      const items=section=>sensor(section)?.attributes?.[section]||[];
      const html=this.nbaOverviewPage(SPORTS.nba,items,sensor);
      [...content.children].filter(node=>node!==notice).forEach(node=>node.remove());
      content.insertAdjacentHTML('beforeend',html);
    }
  }
  ...
  if(this.sport==='nba'){
    this.shadowRoot.querySelectorAll('[data-live-game]').forEach(button=>{if(!button.dataset.nbaBound){button.dataset.nbaBound='1';button.addEventListener('click',()=>this.openLiveGame(button.dataset.liveGame));}});
    this.shadowRoot.querySelectorAll('[data-nba-team-id]').forEach(button=>button.addEventListener('click',()=>{const teamId=button.dataset.nbaTeamId,teamName=button.dataset.nbaTeamName||'';if(!teamId)return;this.team=teamName;localStorage.setItem('usa_sports_hub_team',teamName);this.tab='My Team';localStorage.setItem('usa_sports_hub_nba_tab','My Team');this._hass?.callService('usa_sports_hub','select_team',{sport:'nba',team_id:teamId}).catch(err=>console.warn(err));this.render();}));
  }
};
