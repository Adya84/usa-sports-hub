        ...
        detail["statistics"] = _dedupe_dicts(
            _objects_with_keys(
                combined,
                {
                    ...
                    "blocked_shots", "penalty_minutes", "pim", "plus_minus",
                    "power_play_goals", "power_play_points", "short_handed_goals",
                    "faceoff_percentage", "faceoff_wins", "save_percentage",
        ...
        detail["situations"] = _dedupe_dicts(
            _objects_with_keys(
                combined,
                {
                    ...
                    "power_play", "strength", "penalty", "penalties",
                    "empty_net", "goalie_pulled",
                    "pitcher", "batter",
                },
                100,
            ),
