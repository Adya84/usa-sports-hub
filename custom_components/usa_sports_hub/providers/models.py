"""Provider-independent normalizers for theScore payloads."""
...
def normalize_the_score_team(team: dict[str, Any]) -> dict[str, Any]:
...
def normalize_the_score_event(event: dict[str, Any], league: str) -> dict[str, Any]:
...
def normalize_the_score_standing(row: dict[str, Any], league: str) -> dict[str, Any]:
    team = row.get("team") if isinstance(row.get("team"), dict) else {}
    normalized_team = normalize_the_score_team(team)
...
def compact_the_score_news(events: list[dict[str, Any]]) -> list[dict[str, Any]]:
            ...
            result.append(
                {
                    ...
                    "url": f"https://www.thescore.com{uri}" if isinstance(uri, str) and uri.startswith("/") else None,
                    "kind": kind,
                    "game_id": str(event.get("id") or ""),
